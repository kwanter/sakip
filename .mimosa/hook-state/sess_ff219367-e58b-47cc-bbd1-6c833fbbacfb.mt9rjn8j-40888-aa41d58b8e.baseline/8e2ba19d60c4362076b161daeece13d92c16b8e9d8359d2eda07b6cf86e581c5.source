...
<div class="container py-4">
    ...
    <div class="page-header">
        <div class="page-header-layout">
            <div>
                ...
                <h1 class="page-header-title">Edit Instansi</h1>
                <p class="page-header-subtitle">Perbarui data instansi pemerintahan</p>
            </div>
        </div>
    </div>
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('sakip.instansi.update', $instansi) }}" method="POST">
                @csrf
                @method('PUT')
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kode_instansi') is-invalid @enderror"
                                       id="kode_instansi" name="kode_instansi" value="{{ old('kode_instansi', $instansi->kode_instansi) }}" required
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('nama_instansi') is-invalid @enderror"
                                       id="nama_instansi" name="nama_instansi" value="{{ old('nama_instansi', $instansi->nama_instansi) }}" required
                        ...
                        <div class="col-12">
                            <div class="form-group mb-0">
                                ...
                                <textarea class="form-control @error('alamat') is-invalid @enderror"
                                          id="alamat" name="alamat" rows="3" placeholder="Masukkan alamat lengkap">{{ old('alamat', $instansi->alamat) }}</textarea>
                                @error('alamat')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('telepon') is-invalid @enderror"
                                       id="telepon" name="telepon" value="{{ old('telepon', $instansi->telepon) }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-3">
                                ...
                                <input type="email" class="form-control @error('email') is-invalid @enderror"
                                       id="email" name="email" value="{{ old('email', $instansi->email) }}"
                        ...
                        <div class="col-md-4">
                            <div class="form-group mb-0">
                                ...
                                <input type="url" class="form-control @error('website') is-invalid @enderror"
                                       id="website" name="website" value="{{ old('website', $instansi->website) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control @error('kepala_instansi') is-invalid @enderror"
                                       id="kepala_instansi" name="kepala_instansi" value="{{ old('kepala_instansi', $instansi->kepala_instansi) }}"
                        ...
                        <div class="col-md-6">
                            <div class="form-group mb-0">
                                ...
                                <input type="text" class="form-control @error('nip_kepala') is-invalid @enderror"
                                       id="nip_kepala" name="nip_kepala" value="{{ old('nip_kepala', $instansi->nip_kepala) }}"
