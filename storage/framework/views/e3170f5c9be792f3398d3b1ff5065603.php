...
<div class="container-fluid">
    ...
    <?php if($sasaranStrategis->isEmpty()): ?>
    <div class="alert alert-warning">
        ...
        <a href="<?php echo e(route('sakip.sasaran-strategis.create')); ?>" class="btn btn-sm btn-primary ml-2">
    ...
    <div class="row">
        <div class="col-lg-12">
            <div class="card shadow mb-4">
                ...
                <div class="card-body">
                    <form action="<?php echo e(route('sakip.program.store')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>"
                                            id="instansi_id" name="instansi_id" required <?php echo e($sasaranStrategis->isEmpty() ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                            id="sasaran_strategis_id" name="sasaran_strategis_id" required <?php echo e($sasaranStrategis->isEmpty() ? 'disabled' : ''); ?>>
...
unset($__errorArgs, $__bag); ?>"
                                           id="kode_program" name="kode_program" value="<?php echo e(old('kode_program')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="nama_program" name="nama_program" value="<?php echo e(old('nama_program')); ?>" required>
...
unset($__errorArgs, $__bag); ?>"
                                           id="anggaran" name="anggaran" value="<?php echo e(old('anggaran', 0)); ?>" min="0" step="1" required>
...
unset($__errorArgs, $__bag); ?>" id="tahun" name="tahun" required>
                                        ...
                                        <?php for($year = date('Y'); $year <= date('Y') + 5; $year++): ?>
                                            <option value="<?php echo e($year); ?>" <?php echo e(old('tahun', date('Y')) == $year ? 'selected' : ''); ?>>
                                                <?php echo e($year); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="form-group">
                            <button type="submit" class="btn btn-primary" <?php echo e($sasaranStrategis->isEmpty() ? 'disabled' : ''); ?>>
...
$(document).ready(function() {
    ...
    <?php if(old('instansi_id')): ?>
        $('#instansi_id').trigger('change');
        <?php if(old('sasaran_strategis_id')): ?>
            setTimeout(function() {
                $('#sasaran_strategis_id').val('<?php echo e(old('sasaran_strategis_id')); ?>');
            }, 500);
        <?php endif; ?>
    <?php endif; ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /Users/macbook/Developer/php/sakip/resources/views/sakip/program/create.blade.php ENDPATH**/ ?>